...
def init_repo():
    ...
    contents = {}
    jrepo = json.loads(open("EC_SezonAscend_Main/dynamicmcpack.repo.json", "r").read())
...
def save_jrepo():
    global jrepo
    open("EC_SezonAscend_Main/dynamicmcpack.repo.json", "w").write(json.dumps(jrepo, indent='\t'))
    calc_sha1_hash("EC_SezonAscend_Main/dynamicmcpack.repo.json")
